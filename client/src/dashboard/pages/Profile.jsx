...
<form onSubmit={handlePasswordChange}>
    <div className='space-y-4'>
        <div>
            ...
            <input type="password" id='old_password' name='old_password' value={oldPassword} onChange={(e) => setOldPassword(e.target.value)} placeholder='Enter Old Passowrd' className='w-full px-3 py-2 mt-2 border border-gray-400 rounded-md focus:ring-2 focus:ring-blue-500 outline-none transition duration-300' />
        </div>


        <div>
            <label htmlFor="new_password" className='block text-md font-semibold text-gray-600'>New Password </label>
            <input type="password" id='new_password' name='new_password' placeholder='Enter New Passowrd' value={newPassword} onChange={(e) => setNewPassword(e.target.value)}  className='w-full px-3 py-2 mt-2 border border-gray-400 rounded-md focus:ring-2 focus:ring-blue-500 outline-none transition duration-300' />
        </div> 
    </div>
